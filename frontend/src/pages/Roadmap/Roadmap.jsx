...
const Roadmap = () => {
    ...
    const calculateXPosition = (index) => {
        ...
        const positionInGroup = index % maxCirclesPerGroup;
        let xOffset;
    ...
    const handleAddCircle = async () => {
        const newCircle = {
            id: circles.length + 1,
            x: calculateXPosition(circles.length),
            y: calculateYPosition(circles.length),
        ...
        try {
            ...
            console.error("Error adding new roadmap item:", error);
        }
    };
